...
public class PullableUpAndDownListView extends ListView implements Pullable{

	public PullableUpAndDownListView(Context context) {
		super(context);
	}

	public PullableUpAndDownListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PullableUpAndDownListView(Context context, AttributeSet attrs, int defStyle) {
