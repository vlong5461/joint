...
//		refreshingView.setVisibility(View.GONE);
		...
		case SUCCEED:
			...
			refreshStateImageView.setBackgroundResource(R.drawable.shouye_shuaxin);
			break;
		case FAIL:
		default:
			// 刷新失败
	...
	public void loadmoreFinish(int refreshResult) {
		...
		case DOWN_BOTTOM:
			//加载到底部
			loadStateImageView.setVisibility(View.GONE);
			loadStateTextView.setText(R.string.down_bottom);
			loadStateImageView.setBackgroundResource(R.drawable.load_succeed);
			break;
		case FAIL:
		default:
...
//			refreshingView.startAnimation(refreshingAnimation);
			refreshStateTextView.setText(R.string.refreshing);
			refreshingView.setBackgroundResource(R.drawable.pull_refresh_anim);
			animationDrawable=(AnimationDrawable)refreshingView.getBackground();
			animationDrawable.stop();
