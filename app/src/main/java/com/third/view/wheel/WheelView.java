...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(getResources().getColor(R.color.orange_red));
            } else {
                itemView.setTextColor(getResources().getColor(R.color.common_text_gray));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(getResources().getColor(R.color.splite_line));
