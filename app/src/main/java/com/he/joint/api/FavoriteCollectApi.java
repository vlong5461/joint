...
public class FavoriteCollectApi  extends BaseApi {

    public void sendRequest(String id,String user_id,String user_token) {
        long time =System.currentTimeMillis();
        String url= URLHelper.collectURL+
                "?id="+id +"&user_id=" +user_id+"&user_token=" +user_token
