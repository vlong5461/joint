...
import com.he.joint.bean.MaterialCategoryBean;
...
public class MaterialCategoryApi extends BaseApi {

    public void sendRequest() {
        long time =System.currentTimeMillis();
        String url= URLHelper.materialCategoryURL+
    ...
    protected void parseData(JSONObject response) {
        if (contentCode == Consts.ContentCode.Success) {
            try {
                ...
                MaterialCategoryBean bean = parseJsonObject(dataJson.toString(), MaterialCategoryBean.class);
                responseData = bean;
