...
public class ExpertReplyListApi  extends BaseApi {

    public void sendRequest(String page,String expert_id,String sort) {
        long time =System.currentTimeMillis();
        String url= URLHelper.expertReplyListURL+
                "?page="+page+"&expert_id=" +expert_id+"&sort=" +sort
    ...
    protected void parseData(JSONObject response) {
        if (contentCode == Consts.ContentCode.Success) {
            try {
                ...
                ExpertReplyListBean bean = parseJsonObject(dataJson.toString(), ExpertReplyListBean.class);
                responseData = bean;
