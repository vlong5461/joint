...
public class QuestionDetailApi extends BaseApi {

    public void sendRequest(String id) {
        long time =System.currentTimeMillis();
        String url= URLHelper.questionDetailURL+
    ...
    protected void parseData(JSONObject response) {
        if (contentCode == Consts.ContentCode.Success) {
            try {
                ...
                QuestionDetailBean bean = parseJsonObject(dataJson.toString(), QuestionDetailBean.class);
                responseData = bean;
