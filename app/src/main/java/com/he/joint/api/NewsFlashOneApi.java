...
public class NewsFlashOneApi extends BaseApi {

    public void sendRequest() {
        long time =System.currentTimeMillis();
        String url= URLHelper.newsFlashOneURL+
    ...
    protected void parseData(JSONObject response) {
        if (contentCode == Consts.ContentCode.Success) {
            try {
                ...
                NewsFlashOneBean bean = parseJsonObject(dataJson.toString(), NewsFlashOneBean.class);
                responseData = bean;
