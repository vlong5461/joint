...
public class MainQuestionView extends LinearLayout {

    private Context mContext;
    private List<HomeAreaBean> areaList;

    public MainQuestionView(Context context) {
        super(context);
        mContext = context;
    }

    public MainQuestionView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public MainQuestionView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public class HomeViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            MainQuestionViewItem v = (MainQuestionViewItem) LayoutInflater.from(mContext).inflate(R.layout.view_main_viewpaper_item, MainQuestionView.this, false);
