...
public class MainHomeVeiw extends LinearLayout {
    ...
    public MainHomeVeiw(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public MainHomeVeiw(Context context, AttributeSet attrs, int defStyle) {
...
public void setData(){
    ...
    public class HomeViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            MainHomeViewItem v = (MainHomeViewItem) LayoutInflater.from(mContext).inflate(R.layout.view_main_viewpaper_item, MainHomeVeiw.this, false);
